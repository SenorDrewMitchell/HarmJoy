...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { end_day_id: @race.end_day_id, name: @race.name, start_day_id: @race.start_day_id }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { end_day_id: @race.end_day_id, name: @race.name, start_day_id: @race.start_day_id }
    assert_redirected_to race_path(assigns(:race))
  end
